      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
        ...
        <div className="flex space-x-6">
          <div className="flex items-center space-x-2">
            {/* Phone Icon */}
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 00-1.01.24l-2.2 2.2a15.116 15.116 0 01-6.59-6.59l2.2-2.21a.96.96 0 00.25-1.01A11.36 11.36 0 018.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 13.98 13.98 0 0013.96 13.96c.55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1z"/></svg>
...
<a href="#" className="hover:text-gray-300">
  <svg 
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 640"
    className="w-4 h-4"       // Makes it small
    fill="currentColor"       // Makes it white
  >
